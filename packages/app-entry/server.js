...
server.listen(currentPort, (err) => {
  ...
  const nextServer = new NextServer({
    ...
    conf: {
      ...
      serverRuntimeConfig: {},
      publicRuntimeConfig: { staticFolder: '/release/0.0.0' },
      ...
      experimental: {
        ...
        outputFileTracingRoot: '/Users/huntharo/pwrdrvr/microapps-app-release/',
